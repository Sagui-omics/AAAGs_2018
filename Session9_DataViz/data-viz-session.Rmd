...
This session will teach you how to visualize your data in R. Plots are useful for explorating and communicating your data to others. The R packages that we will focus on are ggplot2 and Gviz. First, we will review the basics of these packages. Following this, we will use these tools to visualize the VCF data that were produced earlier in the workshop.
